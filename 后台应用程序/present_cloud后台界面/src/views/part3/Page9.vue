<template>
    <div>
        ...
        <el-dialog
            ...
            </span><el-form ref="form" :model="form" label-width="180px">
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" label-width="180px">
                ...
                <el-form-item label="类型"> <el-form-item label="数据名称">
...
<script>
    ...
    export default {
        ...
        methods: {
            submitEdit () {
                var _this=this;
                _this.$axios.get('http://111.231.104.12:8051/index/app/editFireSubmit?id='+_this.editId+"&name="+this.form.name)
            ...
            */ 
            handleEdit: function (index, row) {
                this.getDictypess()
                var _this=this;
                this.$axios.get('http://111.231.104.12:8051/index/app/editfire?id='+index)
                    .then(function (response) {
            ...
            handleDel: function (index, row) {
				...
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					this.$axios.get('http://111.231.104.12:8051/index/app/delefire?id='+index)
					    .then(function (response) {
            ...
            */ 
            getDicList () {
                this.$axios.get('http://111.231.104.12:8051/index/app/getFireList', {
                    emulateJSON: true
                }, {
                    headers: {
            ...
            adddicType () {
                var vm = this
                this.$axios.post('http://111.231.104.12:8051/index/app/saveFire',qs.stringify(
                {
                    name:this.form.name,
                    }))
                    .then(function (response) {
