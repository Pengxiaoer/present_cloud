<template>
  <div>
    ...
    <div v-if="tabShow">
        ...
        <br>
        <br>
        <van-button type="primary" size="large" @click="logoutbk">退出班课</van-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    logoutbk () {
        axios.get('http://111.231.104.12:8051/index/app/logoutbk?courseid=' + this.courseid + "&userid=" + this.userId, {
        emulateJSON: true
      }, {
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
