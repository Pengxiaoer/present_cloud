<template>
  <div>
    <div>
      <x-header :left-options="{backText: ''}" style="background-color: #3399ff;">个人中心</x-header>
    </div>
    <div class="content">
      <div class="img_area">
      ...
      <div class="aa">
        <x-button style="background-color: #3399ff;" class="bb" type="primary" @click.native="LoginOut">退出登陆</x-button>
      </div>
    </div>
    <tabbar>
  ...
  export default {
    ...
    methods: {
      ...
      showData () {
        ...
        axios.get('http://47.106.217.11:8083/Self', {
          params: {
            stno: this.userName
          }
        }).then((response) => {
