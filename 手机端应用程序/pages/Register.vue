  ...
  methods: {
    getVerifyCode () {
      if (this.validatePhone()) {
        ...
        axios.post('http://111.231.104.12:8051/index/app/getCode', qs.stringify({
    ...
    register: function () {
      ...
      if (this.ClassNumber.length !== 9) {
        ...
        axios.post('http://47.106.217.11:8083/register', qs.stringify({
          ...
          if (res.data.code === 200) {
            axios.get('http://111.231.104.12:8051/index/app/addroid?id=' + this.radio + "&stno=" + this.ClassNumber + "&tel="+this.PhoneNumber, {
              emulateJSON: true
            }, {
              headers: {
                'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
